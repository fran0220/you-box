...
<p align="center">
  <a href="https://raw.githubusercontent.com/fran0220/you-box/main/LICENSE">
    <img src="https://img.shields.io/github/license/fran0220/you-box?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/fran0220/you-box/releases/latest">
    <img src="https://img.shields.io/github/v/release/fran0220/you-box?color=brightgreen&include_prereleases" alt="version">
  </a><!--
...
<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=you-box">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
- 🔍 Requête de quota d'utilisation de clé (avec [you-box-key-tool](https://github.com/fran0220/you-box-key-tool))
...
> [!TIP]
> **Dernière image Docker:** `boxai:local`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `you-box` |
...
| Projet | Description |
|------|------|
| [you-box-key-tool](https://github.com/fran0220/you-box-key-tool) | Outil de recherche de quota d'utilisation avec une clé |
| [you-box-horizon](https://github.com/fran0220/you-box-horizon) | Version optimisée haute performance de BoxAI |
...
Si les politiques de votre organisation ne permettent pas les logiciels sous licence AGPLv3, consultez votre conseil juridique avant de déployer ou de distribuer des versions modifiées.
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=fran0220/you-box&type=Date)](https://star-history.com/#fran0220/you-box&Date)
