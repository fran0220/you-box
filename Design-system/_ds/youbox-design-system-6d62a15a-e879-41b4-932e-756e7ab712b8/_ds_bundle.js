...
injectStyles();
const PALETTE = ['#9A9AA4', '#74747F', '#565663', '#C2C2C9', '#3B3B47', '#8B9097', '#807C75', '#A7ABB1'];
...
function injectStyles() {
  ...
  .yb-switch input:checked + .yb-switch__track .yb-switch__thumb{transform:translateX(17px);background:var(--brand-on)}
