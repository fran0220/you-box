# Dual-host deploy checklist (jpdata + bwg)

Image registry: `ghcr.io/fran0220/you-box`

| Host | App dir | Container | Domain | Local port |
| --- | --- | --- | --- | --- |
| `jpdata` | `/opt/you-box` | `new-api` | `https://api.you-box.com/` | `3000` |
| `bwg` | `/opt/origin-gateway` | `origin-gateway` | `https://api.origingame.dev/` | `127.0.0.1:9320` |
...
### jpdata `/opt/you-box/.env`

```bash
BOXAI_IMAGE=ghcr.io/fran0220/you-box:v0.1.7
PORT=3000
NODE_NAME=jpdata-youbox-1
FRONTEND_BASE_URL=https://api.you-box.com
...
- Same image tag/digest on both hosts for a given release.
...
curl -fsSI https://api.you-box.com/api/status | head
```
...
- Do not share one DB between jpdata and bwg by accident.
