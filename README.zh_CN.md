...
<p align="center">
  <strong>感谢 <a href="https://www.jetbrains.com/?from=you-box">JetBrains</a> 为本项目提供免费的开源开发许可证</strong>
</p>
...
- 📱 Telegram 授权登录
- 🔑 OIDC 统一认证
- 🔍 Key 查询使用额度（配合 [you-box-key-tool](https://github.com/fran0220/you-box-key-tool)）
...
| `PYROSCOPE_APP_NAME` | Pyroscope 应用名                                        | `you-box` |
...
| 项目 | 说明 |
|------|------|
| [you-box-key-tool](https://github.com/fran0220/you-box-key-tool) | Key 额度查询工具 |
| [you-box-horizon](https://github.com/fran0220/you-box-horizon) | BoxAI 高性能优化版 |
...
如果您所在的组织政策不允许使用 AGPLv3 许可的软件，请在部署或分发修改版本前咨询法律顾问。
