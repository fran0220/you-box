...
// AdminResetUserSubscriptionsByPlan resets active subscriptions of one user for a plan.
...
// AdminResetPlanSubscriptions resets all active subscriptions of a plan.
