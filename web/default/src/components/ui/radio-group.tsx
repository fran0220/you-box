...
function RadioGroupItem({ className, ...props }: RadioPrimitive.Root.Props) {
  return (
    ...
    >
      ...
      >
        <span className='bg-primary-foreground motion-safe:animate-in motion-safe:zoom-in-50 duration-fast ease-spring absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2 rounded-full' />
      </RadioPrimitive.Indicator>
    </RadioPrimitive.Root>
  )
}
