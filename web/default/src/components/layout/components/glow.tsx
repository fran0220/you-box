...
export function Glow({ className, variant, ...props }: GlowProps) {
  return (
    ...
    >
      ...
      <div
        className={cn(
          'absolute left-1/2 h-[128px] w-[40%] -translate-x-1/2 scale-200 rounded-[50%] bg-radial from-[rgba(56,158,255,0.5)] from-10% to-[rgba(56,158,255,0)] to-60% opacity-30 sm:h-[256px] dark:opacity-70',
          variant === 'center' && '-translate-y-1/2'
        )}
      />
    </div>
