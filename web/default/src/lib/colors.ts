...
/** Monochrome palette: map legacy semantic names to theme chart/muted tokens. */
 ...
 */
/** Grayscale chart strokes — resolved from CSS vars at runtime where possible. */
