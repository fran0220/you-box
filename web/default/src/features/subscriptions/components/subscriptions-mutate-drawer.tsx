...
export function SubscriptionsMutateDrawer({
  ...
  // Standardized validation contract: the surrounding <Form> auto-scrolls the
  // first invalid FormItem into view + focuses it; onInvalid just surfaces the
  // toast. (No collapsible sections here, so nothing to auto-expand.)
  const onInvalid: SubmitErrorHandler<PlanFormValues> = () => {
  ...
  // Reset on EVERY dismissal path. The footer Cancel calls this directly
  // because a controlled Sheet does not re-fire onOpenChange when `open` is
  // flipped externally — so wiring Cancel to the raw onOpenChange would skip
  // the reset that ESC/overlay/X dismissals get.
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t('Shown to customers on the pricing and checkout pages.')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t('Optional one-line tagline displayed under the title.')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {t('The price the customer pays, in USD.')}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t('Lower values are listed first on the pricing page.')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                ...
                render={({ field }) => (
                  <FormItem className='gap-0'>
                    <DrawerSwitchRow
                      ...
                      description={t(
                        'Disabled plans are hidden from customers.'
                      )}
                      control={
                        <FormControl>
                          <Switch
                ...
                render={({ field }) => (
                  <FormItem className='gap-0'>
                    <DrawerSwitchRow
                      ...
                      description={t(
                        'Let customers pay for this plan using their account balance.'
                      )}
                      control={
                        <FormControl>
                          <Switch
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {t(
                        'Time unit for the subscription length. Choose Custom to set an exact number of seconds.'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {t('Exact subscription length in seconds.')}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {t('How many of the selected unit the plan lasts.')}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {t(
                        'How often the remaining quota is replenished. Choose Custom to set an exact interval.'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {t(
                        'Reset interval in seconds. Enabled only when Reset Cycle is set to Custom.'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t(
                      'Maps this plan to a Stripe price for checkout. Leave blank if Stripe is not used.'
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t(
                      'Maps this plan to a Creem product for checkout. Leave blank if Creem is not used.'
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
