...
/** Generative-media vendors grouped by modality. Vendor names stay
 * untranslated; group labels go through i18n. */
...
/**
 * Generative-media wall: the same key also drives image, video, audio and 3D
 * models. Hairline-divided rows, one modality per row — no cards.
 */
