    ...
    build: (settings: OperationsSettings) => (
      <EmailSettingsSection
        defaultValues={{
          ...
          EmailBrandLogoURL: settings.EmailBrandLogoURL,
          EmailBrandPrimaryColor: settings.EmailBrandPrimaryColor,
          EmailBrandFooterText: settings.EmailBrandFooterText,
          EmailVerificationSubject: settings.EmailVerificationSubject,
          EmailVerificationTitle: settings.EmailVerificationTitle,
          EmailVerificationLead: settings.EmailVerificationLead,
          PasswordResetSubject: settings.PasswordResetSubject,
          PasswordResetTitle: settings.PasswordResetTitle,
          PasswordResetLead: settings.PasswordResetLead,
          PasswordResetButtonText: settings.PasswordResetButtonText,
        }}
      />
    ),
  },
