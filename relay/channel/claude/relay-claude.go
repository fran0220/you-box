...
// buildClaudeFileMessage converts an OpenAI file content part into a Claude
// content block. Only PDF (document) and plain text (inline text) are
// supported; other file types are skipped instead of being mis-sent as
// images, which the Claude API would reject.
